...
\subsubsection{Resultados do serviço SFTP}

Após a autenticação, foram realizados testes de envio e recebimento de arquivos para validar o funcionamento do serviço SFTP.
...
Os testes confirmaram o correto funcionamento do serviço, permitindo a transferência de arquivos entre o cliente e o servidor utilizando o protocolo SFTP de forma segura através da porta TCP 22.
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{fig/grafanaAdm.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{fig/grafanaPostgreP.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{fig/grafanaPostgresE.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{fig/grafanaZabbixP.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{fig/grafanaZabbixE.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{fig/conexao.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{fig/conexaoZabbix.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{fig/conexaoZabbix2.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{fig/conexaoZabbix3.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{fig/conexaoZabbix4.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{fig/dashboard1.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{fig/dashboard2.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{fig/dashboard3.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{fig/dashboard4.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{fig/dashboard5.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{fig/dashboard6.png}
